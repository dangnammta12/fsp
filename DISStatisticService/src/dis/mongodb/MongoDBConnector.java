...
public class MongoDBConnector {
	...
	public static final TError CHUNK_COLLECTION_NOT_FOUND;	
	public static final TError FILE_COLLECTION_NOT_FOUND;
	public static final TError STATISTIC_NOT_FOUND;
	public static final TError STATISTIC_ERROR;
	public static final TError STATISTIC_EXISTED;
	...
	static {
		...
		CHUNK_COLLECTION_NOT_FOUND = new TError(TErrorCode.EC_CHUNK_COLLECTION_NOT_FOUND.getValue(),"Chunk collection not found");
		FILE_COLLECTION_NOT_FOUND = new TError(TErrorCode.EC_FILE_COLLECTION_NOT_FOUND.getValue(),"File Collection not found");
		STATISTIC_NOT_FOUND = new TError(TErrorCode.EC_STATISTIC_NOT_FOUND.getValue(),"Statistic not found");
		STATISTIC_ERROR = new TError(TErrorCode.EC_STATISTIC_ERROR.getValue(),"Unable update Statistic");
		STATISTIC_EXISTED = new TError(TErrorCode.EC_STATISTIC_EXISTED.getValue(),"Statistic existed");
	}
