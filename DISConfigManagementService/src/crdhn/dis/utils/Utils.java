...
public class Utils {
    ...
    public static String convertMiliTimeToText(long miliSecondRemain) {
        if (miliSecondRemain <= 0) {
            return "";
        } else if (miliSecondRemain / (24 * 60 * 60 * 1000) > 0) {
            return miliSecondRemain / (24 * 60 * 60 * 1000) + " day ago";
        } else if (miliSecondRemain / 3600000 > 0) {
            return miliSecondRemain / 3600000 + " hour ago";
        } else if (miliSecondRemain / 60000 > 0) {
            return miliSecondRemain / 60000 + " minute ago";
        } else {
            return miliSecondRemain / 1000 + " second ago";
        }
    }
