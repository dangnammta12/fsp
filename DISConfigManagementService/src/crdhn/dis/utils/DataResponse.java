...
public class DataResponse {
    ...
    public static final DataResponse AUTHENTICATION_FAIL = new DataResponse(1001, "Wrong Email or password");
    ...
    public static final DataResponse CANNOT_DELETE_ITEM = new DataResponse(1013, "Cannot delete this agent, please check status and make sure doesn't contain any app");
    public static final DataResponse MONGO_WRITE_EXCEPTION = new DataResponse(1006, "Mongo Write Failed!");
    public static final DataResponse MONGO_ITEM_NOT_FOUND = new DataResponse(1007, "Mongo NOT FOUND!");
    public static final DataResponse MONGO_PERMISSION_DENY = new DataResponse(1008, "permission deny!");
    public static final DataResponse CANNOT_CONNECT_MONGO = new DataResponse(1009, "permission deny!");
    public static final DataResponse MONGO_USER_NOT_EXIST = new DataResponse(1010, "User not existed!");
    
    public static final DataResponse MONGO_ITEM_EXISTED = new DataResponse(1009,"Item existed!");
    
    public static final DataResponse MONGO_FOLDERNAME_EXISTED = new DataResponse(1011, "Folder name is already used in this location. Please use a different name.!");

    public static final DataResponse AGENT_IP_NOT_ACCEPTED = new DataResponse(1012, "Agent IP is not accepted!");
