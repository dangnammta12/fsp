...
public class ServletUtil {
    ...
    public static boolean getBooleanParameter(Request request, String paramName) {
        return getBooleanParameter(request, paramName, false);
    }
    
    public static Boolean getBooleanParameter(Request request, String paramName, boolean defaultValue) {
