    ...
    <body class="sidebar-mini skin-blue">
        ...
        <div class="wrapper" style="height: auto;">
            ...
            <section class="content-header">
                <div class="row">
                    <div class="col-md-9">
                        <ol id="menu_horizontal" class="breadcrumb text-left" style="background-color:#ecf0f5;">
                        </ol>
                    ...
                    <div class="col-md-3 text-right">
                        ...
                        <ul class="dropdown-menu">
                          <li><a id="btn_createFolder" href="javascript:void(0);">Folder</a></li>
                          <li><a id="btn_file_upload" href="javascript:void(0);">File Upload</a></li>
                          <li><a id="btn_upload_width_path" href="javascript:void(0);">File Upload With Path</a></li>
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <script>
            $(document).ready(function () {
                renderPage(${folderId}, "owner", false);
