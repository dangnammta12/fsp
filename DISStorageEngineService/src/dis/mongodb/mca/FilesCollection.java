...
//				ex.printStackTrace();
	...
	//upload
	public GetRefFileInfoResponse findExistedRefFileInfo(FileInfo fileInfo) {
...
//			collection.insertOne(fileDocument);
			...
			Bson update = Updates.combine(
					...
					Updates.setOnInsert("appKey", fileInfo.appKey),
...
//				response.fileInfo.ownerName = fileDocument.getString("ownerName");
				...
				for (Document doc : docs) {
					if (doc.getLong("fileId") == fileId) {
						...
						response.fileInfo.appKey = doc.getString("appKey");
						break;
					}
				}
