                                    ...
                                    <div class="col-md-9">
                                      ...
                                      <form id="eventForm" class="form-horizontal" role="form" autocomplete="off">
                                        <div class="form-group required">
                                          ...
                                          <div class="col-lg-8">
                                            <input id="val_fullname" name="fullname" class="form-control" value="" type="text">
                                          </div>
                                        </div>
                                        <div class="form-group required">
                                          <label class="col-lg-3 control-label">Email</label>
                                          <div class="col-lg-8">
                                            <input id="val_email" class="form-control" name="email" value="" type="text">
                                          </div>
                                        </div>
                                        <div class="form-group required">
                                        ...
                                        <div class="form-group" id="sandbox-container">
                                            ...
                                            <div class="col-xs-5 date">
                                                <div class="input-daterange input-group input-append date" id="datepicker">
                                                    <input id="val_birthday" name="birthday" type="text" class="input-sm form-control" placeholder="DD/MM/YYYY" autocomplete="off"/>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-8">
                                            <input id="val_department" name="department" class="form-control" value="" type="text">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="col-md-3 control-label">Phone number</label>
                                          <div class="col-md-8">
                                                <input id="val_phone" name="phone" class="form-control" value="" type="text">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="col-md-3 control-label">Address</label>
                                          <div class="col-md-8">
                                                <textarea id="val_address" name="address" rows="3" class="form-control" value=""></textarea>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="col-md-3 control-label"></label>
                                          <div class="col-md-8">
                                            <input onclick="createUser();" class="btn btn-primary" value="Register" type="button">
                                          </div>
                                        </div>
                                      </form>
                                    </div>
