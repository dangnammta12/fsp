...
public class ServletUtil {
    ...
    public static Long getFileIdFromParameter(Request request, String paramName) {
        String paramString = getStringParameter(request, paramName);
        if (paramString == null || paramString.isEmpty() || !paramString.contains("file_")) {
            return 0l;
        }
        String paramFileId = paramString.substring("file_".length(), paramString.length());
        return Long.valueOf(paramFileId);
